{
    ...
    "STRINGS": {
        "_asena": {
            ...
            "DESC": "විස්තරය",
            "EXAMPLE": "උදාහරණ",
            "NOT_FOUND": "මෙවැනි විධානයක් සොයා ගත නොහැක*",
            "WARN": "අනුතුරු ඇගවීම්"
        },
        "_plugin": {
            "INSTALL_DESC": "අමතර plugins install කිරීම.",
            "NEED_URL": "කරුණාකර URL ඇතුලත් කරන්න! උදාහරණ:",
            "UNOFF": "⚠️ *අවවාදයයි!* \n*ඔබ install කරන ලද පණිවිඩය Unofficial!*",
        ...
        "updater": {
            ...
            "AFTER_UPDATE": "*💬 WhatsAsena Restarting Automatically!*",
        ...
        "scam": {
            "SCAM_DESC": "Creates fake actions.",
        ...
        "instagram": {
            ...
            "NAME": "Name",
            "BIO": "Biography",
            "FİX": "*Carrying out maintenance work!*",
            "FOLLOWERS": "Followers",
            "FOLLOWS": "Follows",
